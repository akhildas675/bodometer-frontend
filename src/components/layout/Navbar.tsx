...
const Navbar = () => {
  ...
  return (
  <nav className="fixed top-8 left-1/2 transform -translate-x-1/2 z-50 w-[90%] max-w-5xl mx-auto flex items-center justify-between py-3 px-6 rounded-full border border-purple-500/30 shadow-2xl backdrop-blur-xl bg-[#140c3c]/85 text-white transition-all duration-300">
