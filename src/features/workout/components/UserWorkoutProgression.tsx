import { workoutPlanService } from "@/features/workout/services/workout-plan.service";
...
import { WorkoutProgressResponse } from "@/features/workout/types/workout.types";
import { TIMEFRAME, Timeframe } from "@/features/health/constants/fitness.constants";
import {
  Chart as ChartJS,
  CategoryScale,
  LinearScale,
...
import {
  ...
  lineDataset,
  tickColor,
} from "@/components/shared/DashboardStatCards";
...
const UserWorkoutProgression = () => {
  ...
  const fetchProgress = useCallback(async () => {
    setLoading(true);
    try {
      const res = await workoutPlanService.getWorkoutProgress(timeframe);
