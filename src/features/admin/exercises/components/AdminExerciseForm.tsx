...
import { DIFFICULTY_LEVEL, WORKOUT_ENVIRONMENT } from "@/features/health/constants/fitness.constants";
import type { ExerciseFormData } from "@/features/workout/types/exercise.types";
...
import type { UpdateEquipment } from "@/features/workout/types/equipment.types";
