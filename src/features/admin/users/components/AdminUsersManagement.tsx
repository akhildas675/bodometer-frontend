...
import { userColumns } from "@/features/admin/users/components/AdminUsersColumns";
import { useUserActions } from "@/features/admin/users/components/AdminUsersActions";
...
const AdminUsersManagement = () => {
  ...
  const [modalConfig, setModalConfig] = useState<import("./AdminUsersActions").UserModalConfig>({
      isOpen: false,
      title: "",
      message: "",
      onConfirm: () => {},
