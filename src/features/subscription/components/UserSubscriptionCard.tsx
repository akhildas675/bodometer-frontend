...
import { SubscriptionPlan, SubscriptionTransaction } from "@/features/subscription/types/subscription.types";
import { ActiveSubscription } from "@/features/subscription/types/subscription.types";
...
import { transactionColumns } from "@/features/subscription/components/UserTransactionColumns";
...
import { UpgradePreview } from "@/features/subscription/types/subscription.types";
...
const UserSubscription = () => {
  ...
  const [sortConfig, setSortConfig] = useState<
    SortConfig<keyof SubscriptionTransaction>
  >({
    field: "createdAt",
    order: "desc",
  });
  ...
  } = useTableFetch<PaginatedResponse<SubscriptionTransaction>>(
    fetchTransactionsFn,
    false,
  );
  ...
  return (
    <div className="text-white max-w-5xl mx-auto px-4 py-8">
      ...
      {activeSubscription && (
        <div className="bg-linear-to-r from-violet-600/20 to-indigo-600/20 border border-violet-500/30 rounded-2xl p-6 mb-8">
