...
} from "@/features/booking/services/client-booking.service";
import { walletService, UserWalletData, WalletTransactionData } from "@/features/user/services/wallet.service";
...
export const UserMyBookings: React.FC = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      const [bookingsData, requestsData, walletData, txsData, historyData] =
        await Promise.all([
